					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								...
								<a href="/WinterHold_HRM/staff?action=new"
												...
												<tr>
													...
													<td>
														<div class="d-flex">
															...
															</a> <a href="edit?id=${staff.ID_staff}"
																class="btn btn-primary shadow btn-xs sharp me-1"><i
																class="fas fa-pencil-alt"></i></a> <a
																href="delete?id=${staff.ID_staff}"
    ...
    ***********************************-->
    ...
    $(document).ready(function() {
        ...
        $('.showFormButton').click(function(e) {
            ...
            ul.append('<li class="list-group-item">Adress: ' + staff.phoneNumber + '</li>');
