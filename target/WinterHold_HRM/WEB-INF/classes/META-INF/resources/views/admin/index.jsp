...
<head>
 <meta charset="utf-8">
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="../resources/image/png" href="../resources/images/favicon.png">
	
	<link href="../resources/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">
						...
						<div class="card bg-warning invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">Nhân viên</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">Phòng ban</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">Người quản trị</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">Account</span>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="row align-items-center">
									<div class="col-xl-6">
										<div class="card-bx bg-blue">
											<img class="pattern-img" src="../resources/images/pattern/pattern6.png" alt="">
    ...
    ***********************************-->
	...
	<script src="../resources/vendor/jquery-nice-select/js/jquery.nice-select.min.js"></script>
	
	<!-- Apex Chart -->
	<script src="../resources/vendor/apexchart/apexchart.js"></script>
