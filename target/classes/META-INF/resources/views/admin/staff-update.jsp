						...
						<div class="col-xl-12 col-lg-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Update thông tin</h4>
								</div>
								<div class="card-body">
									<div class="basic-form">
										<form
											action="/WinterHold_HRM/admin/staff?action=update&id=${staff.ID_staff }"
											method="post">
												...
												<div class="mb-3 col-md-6">
													...
													<div class="form-check">
														<input class="form-check-input" type="radio" name="gender"
															value="true" <c:if test="${staff.gender}">checked</c:if>>
														<label class="form-check-label">Nam</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="radio" name="gender"
															value="false" <c:if test="${!staff.gender}">checked</c:if>>
											...
											<div class="row">
												...
												<div class="mb-3 col-md-6">
													<label class="form-label">Avatar</label> <input type="text"
														class="form-control disable" name="image"
														value="${staff.image}">
												</div>
											</div>
