...
<!-- FAVICONS ICON -->
<link rel="shortcut icon" type="image/png" href="/WinterHold_HRM/views/resources/images/favicon.png">
<link href="/WinterHold_HRM/views/resources/css/style.css" rel="stylesheet">
...
<body class="vh-100">
							...
							<div class="col-xl-12">
								<div class="auth-form">
									<div class="text-center mb-3">
										<a href="index.html"><img src="/WinterHold_HRM/views/resources/images/logo-full.png"
											alt=""></a>
									</div>
									<h4 class="text-center mb-4">Đăng nhập với tài khoản</h4>
									<form action="/WinterHold_HRM/login" method="post">
										<div class="mb-3">
										...
										<div class="mb-3">
											<label class="mb-1"><strong>Mật khẩu</strong></label> <input
												type="password" name="password" class="form-control" value="123">
										</div>
    ...
    ***********************************-->
	<!-- Required vendors -->
	<script src="/WinterHold_HRM/views/resources/vendor/global/global.min.js"></script>
